# Jenia Makarevich
![](../assets/img/Jenia_Makarevich_small.jpg)

##  Introduction
Jenia Makarevich is a PhD candidate in the Division of Image Processing (LKEB). Her research focuses on predicting tumour growth and developing models for future tumour volume estimation of vestibular schwannoma. By analysing longitudinal MRI data, she aims to characterise individual tumour dynamics over time. The final goal of her work is to create a tool that enables clinicians to optimise follow-up imaging schedules based on predicted tumour progression.
